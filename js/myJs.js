    ...
    Swal.fire({
        ...
        if (result.value) {
            Swal.fire({
                ...
                text: "Hôm nào tớ đón cậu đi chơi nhaaaaaaaaa :v Còn giờ thì chờ gì nữa mà ko inbox cho tớ đi nàoooooo",
                confirmButtonColor: '#83d0c9',
                onClose: () => {
                    //ban thay cho nay chua
                    //thay duong dan vao day nay
                    //de may qc nhieu the
                    window.location = 'https://www.facebook.com/edison.thomas.7545';
                  }
            })
        }
    })
